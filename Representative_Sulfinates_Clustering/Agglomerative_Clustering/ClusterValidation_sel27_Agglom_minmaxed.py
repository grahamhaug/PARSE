...
"""
- Perform 1 Agglomerative Clustering for 27 sulfinates and perfrom pairwise distance calcs.
...
plt.legend(loc='best')
plt.savefig(f'Agglom_n{nclusters}_minmaxed_sulfinates.png', bbox_inches="tight")
...
outData['PD_Max'] = maxs
outData['PD_Avg'] = avgs
outData.to_csv(f'Agglom_Sampling_Performance-minmaxed.csv', index=False, header=True)
