...
for k in range(1,num_runs+1):
    ...
    plt.legend(loc='best')
    plt.savefig(f'kmedoids_k{clusters}_standardized_sulfinates_{k}.png', bbox_inches="tight")
...
outData['PD_Max'] = maxs
outData['PD_Avg'] = avgs
outData.to_csv(f'kmedoids_Sampling_Performance-standardized.csv', index=False, header=True)