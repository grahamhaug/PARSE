...
sf_name = 'SciFi_Sulfoxides_PMI.csv'
#pull in data as DF
sf_df = pd.read_csv(f'{sf_name}')

### Generated Sulfoxide Data ###
gen_name = 'sulfoxide_smiles_last_CalcdProps2.csv'
...
gen_plot = plt.scatter(gen_x1s, gen_y1s,
            c='r', label='Generated',
            linewidths=0.1, alpha=0.5, s=35)

#plot the sf data
sf_plot = plt.scatter(sf_x1s, sf_y1s,
            c='b', label='SciFinder',
            linewidths=0.1, alpha=0.65, s=35)
...
plt.savefig('PMI_Plot.png', bbox_inches="tight")
