...
#K-means Avg. PD
plt.subplot(3,2,2)
n, bins, patches = plt.hist(z1, num_bins, range=[-1, 8], label='Clustered Selection', facecolor='green', alpha=0.5, density=True)
plt.xlabel('Standardized Euclidean Distance')
plt.ylabel('Probability Density')
...
#K-means Avg. PD
plt.subplot(3,2,4)
n, bins, patches = plt.hist(z2, num_bins, range=[-1, 8], label='Clustered Selection', facecolor='green', alpha=0.5, density=True)
plt.xlabel('Standardized Euclidean Distance')
plt.ylabel('Probability Density')
...
#K-Means Max PD
plt.subplot(3,2,6)
n, bins, patches = plt.hist(z3, num_bins, range=[-1, 8], label='Clustered Selection', facecolor='green', alpha=0.5, density=True)
plt.xlabel('Standardized Euclidean Distance')
plt.ylabel('Probability Density')
