...
def remove_charged_smiles(smiles_list):
	...
	- if !=0, the molecule is net charged and is removed 
	- Outputs the # of charged molecules removed
	Input: a list of SMILEs with chem flags already *'ed
	Returns: A truncated list of net neutral SMILEs
	"""

	print(f'\nRemoving SMILEs with net charges...')
	
	#how many incoming
	incoming_length = len(smiles_list)
