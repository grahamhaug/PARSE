...
"""
- Performs repeated (100k) simple random samples of sulfinates
- Calculates the min/max/avg pairwise distances between selected sulfs.
- Outputs the results of each run to a .csv
"""
