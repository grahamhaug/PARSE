...
#import data
import_file_name = 'Random_Sampling_Performance.csv'
incoming_data = pd.read_csv(f'{import_file_name}')

import_file_name2 = 'KMeans_Sampling_Performance.csv'
...
"""
- Reads in summary pairwise distance data from Kmeans/SRS sampling
- Plots these data in a series of histograms for comparison
"""
...
n, bins, patches = plt.hist(x1, num_bins, range=[-1, 8], label='Random Selection', facecolor='blue', alpha=0.25, density=True)
...
#K-means Avg. PD
plt.subplot(3,2,2)
n, bins, patches = plt.hist(z1, z_bins, range=[-1, 8], label='Clustered Selection', facecolor='green', alpha=0.5, density=True)
plt.xlabel('Standardized Euclidean Distance')
plt.ylabel('Probability Density')
...
#Random Avg. Pd
plt.subplot(3,2,3)
n, bins, patches = plt.hist(x2, num_bins, range=[-1, 8], label='Random Selection', facecolor='blue', alpha=0.25, density=True)
...
#K-means Avg. PD
plt.subplot(3,2,4)
n, bins, patches = plt.hist(z2, z_bins, range=[-1, 8], label='Clustered Selection', facecolor='green', alpha=0.5, density=True)
plt.xlabel('Standardized Euclidean Distance')
plt.ylabel('Probability Density')
...
#Random Max PD
plt.subplot(3,2,5)
n, bins, patches = plt.hist(x3, num_bins, range=[-1, 8], label='Random Selection', facecolor='blue', alpha=0.25, density=True)
...
#K-Means Max PD
plt.subplot(3,2,6)
n, bins, patches = plt.hist(z3, z_bins, range=[-1, 8], label='Clustered Selection', facecolor='green', alpha=0.5, density=True)
plt.xlabel('Standardized Euclidean Distance')
plt.ylabel('Probability Density')
