...
### Data Import ###
import_file_name = 'combined_processed_sulfides.csv'
...
rxn_oxidize_sulfide = AllChem.ReactionFromSmarts('[#16X2H0&!$([$([sr5]:[nr5,or5,sr5]),$([sr5]:[cr5]:[nr5,or5,sr5])])&!$(s1cccc1)&!$(SS)&!$(S-[CX3]=[OX1]):1]>>[#16X430&!$(SS):1]=[O]')

#Function appends to a .csv 
oxidize_sulfides(incoming_smiles,rxn_oxidize_sulfide,f'oxidized_{chop_name}')
