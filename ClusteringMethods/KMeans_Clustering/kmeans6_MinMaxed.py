...
#csv containing MinMax scaled mol prop data
#this dataset is MinMax Scaled
...
while i < 11:
    ...
    ax.set_zlabel('Cm', fontsize=10, fontweight='bold')

    # #save the plot to a file
    plt.legend(loc='best')
    plt.savefig(f'kmeans_k6_sulfinates_{i}b.png', bbox_inches="tight")
