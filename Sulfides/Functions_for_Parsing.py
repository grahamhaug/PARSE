...
def look_for_smarts(smiles_list):
    ...
    #SMARTS definition
    #Hits only sulfides; no thiols, no disulfides, no thiophenes
...
def canonicalize_smiles(smiles_list):
    ...
    #output a csv
    parsed_df.to_csv(f'Parsed_SMILES.csv', index=False)
    print(f'Processed SMILES sent to Parsed_SMILES.csv')
