...
### Create meshgrids ###
#SF Sulfoxides
aa, bb = np.mgrid[0:1:500j, 0:1400:500j]
#Generated Sulfoxides
xx, yy = np.mgrid[0:1:500j, 0:1400:500j]
...
ax1.set_ylabel('Bottcher Cm', fontsize=10, fontweight='bold', labelpad=5)
...
ax2.set_ylabel('Bottcher Cm', fontsize=10, fontweight='bold', labelpad=5)
